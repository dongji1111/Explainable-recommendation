...
class Tree:
    ...
    # add! fucntion used to traverse a tree based on the answers made by feature opinion
    ...
    def getVectors_f(self, opinion_matrix, K):
        ...
        for i in range(len(opinion_matrix)):
            ...
            user_response = np.zeros(len(opinion_matrix[0]))  # user response is a 1*F vector
